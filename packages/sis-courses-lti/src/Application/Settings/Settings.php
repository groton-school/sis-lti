...
class Settings implements SettingsInterface
{
    ...
    public const BLACKBAUD_INSTANCE = 'BLACKBAUD_INSTANCE';
    ...
    public function getBlackbaudInstance(): string
    {
        return $this->settings[self::BLACKBAUD_INSTANCE];
    }
}
